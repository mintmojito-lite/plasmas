...
export function FlowButton({ text = "Modern Button", onClick }: { text?: string; onClick?: () => void }) {
    return (
        ...
        >
            ...
            {/* Circle */}
            <span className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-4 h-4 bg-[#a855f7] rounded-[50%] opacity-0 group-hover:w-[220px] group-hover:h-[220px] group-hover:opacity-100 group-hover:shadow-[0_0_30px_#a855f7] transition-all duration-[800ms] ease-[cubic-bezier(0.19,1,0.22,1)]"></span>
